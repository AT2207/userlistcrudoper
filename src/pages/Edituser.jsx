...
useEffect(()=>{
  axios.get("https://67d15eb7825945773eb411e2.mockapi.io/api/v1/users/"+userid)
  .then(res =>{
  ...
  return (
    <div>
      ...
      <div className="app">
      <Formik
      initialValues={{  name:user.name,email:user.email , password:user.password ,confirmpassword:user.confirmpassword}}
